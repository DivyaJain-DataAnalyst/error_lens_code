...
![Contributors](https://img.shields.io/github/contributors/vinit105/error_lens_code?style=for-the-badge) 
...
Whether you are **contributing code, writing documentation, attending discussions, or representing error_lens_code**, you are expected to follow this Code of Conduct.  
...
This Code of Conduct is adapted from the [Contributor Covenant (v3.0)](https://www.contributor-covenant.org/version/3/0/code_of_conduct/), with modifications tailored for **error_lens_code under the Nexus Spring of Code (NSoC’26)**.  
...
We thank every contributor, maintainer, and member for **making error_lens_code a safe, inclusive, and inspiring space.** ✨💡  
...
Let’s make **error_lens_code** a place where everyone feels welcome to **learn, contribute, and innovate.** 🍰🤖💡 
